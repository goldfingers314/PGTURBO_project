...
data[222] = '#wal_init_zero = off \n'
data[223] = '#wal_recycle = on \n'
data[226] = '#wal_writer_delay = 1ms \n'
data[227] = '#wal_writer_flush_after = 0 \n'
data[230] = '#commit_delay = 0 \n'
data[231] = '#commit_siblings = 5 \n' #This doesn't matter since commit_delay is 0?
data[235] = '#checkpoint_timeout = 5min \n'
...
data[236] = '#checkpoint_completion_target = 0.9 \n'
...
data[237] = '#checkpoint_flush_after = 0 \n'


#!! change does not require restart
data[238] = '#checkpoint_warning = 0 \n'
...
data[386] = '#cpu_index_tuple_cost = 0.005 \n'
...
#Decrease this slightly to make your database favor indexes slightly more.
data[387] = '#cpu_operator_cost = 0.0025 \n'



data[388] = '#parallel_setup_cost = 1000.0 \n'
data[389] = '#parallel_tuple_cost = 0.1 \n'
...
data[394] = '#jit_above_cost = 100000 \n'
...
data[397] = '#jit_inline_above_cost = 500000 \n'
...
data[399] = '#jit_optimize_above_cost = 500000 \n'
...
data[410] = '#geqo_selection_bias = 2.0 \n'
...
data[415] = '#default_statistics_target = 100 \n'
...
data[416] = '#constraint_exclusion = partition \n'
...
data[417] = '#cursor_tuple_fraction = 0.1 \n'
...
data[420] = '#join_collapse_limit = 8 \n'
...
data[422] = '#plan_cache_mode = auto \n'
#
##################### Autovacuum (some parameters) ##################### 
data[619] = '#autovacuum = on \n'
...
data[624] = '#autovacuum_vacuum_threshold = 50 \n'
...
data[626] = '#autovacuum_vacuum_insert_threshold = 1000 \n'
...
data[629] = '#autovacuum_analyze_threshold = 50 \n'
...
data[631] = '#autovacuum_vacuum_scale_factor = 0.2 \n'
...
data[632] = '#autovacuum_vacuum_insert_scale_factor = 0.2 \n'
...
data[634] = '#autovacuum_analyze_scale_factor = 0.1 \n'
...
data[635] = '#autovacuum_freeze_max_age = 200000000 \n'
...
data[637] = '#autovacuum_multixact_freeze_max_age = 400000000 \n'

#Don't know if I want to deal with time related stuff yet
autovacuum_vacuum_cost_delay_list = [-1+x for x in range(102)]
data[640] = '#autovacuum_vacuum_cost_delay = 2ms \n'


autovacuum_vacuum_cost_limit_list = [-1+x*100 for x in range(100)]
data[643] = '#autovacuum_vacuum_cost_limit = -1 \n'
...
data[736] = '#max_locks_per_transaction = 64 \n'
...
data[738] = '#max_pred_locks_per_transaction = 64 \n'
...
data[740] = '#max_pred_locks_per_relation = -2 \n'
...
data[743] = '#max_pred_locks_per_page = 2 \n'
...
list_of_knobs_line_indexes = [126, 132, 137, 138, 139, 140, 141, 142, 160, 185, 186, 187, 188, 189, 190, 191, 193, 236, 237, 386, 387, 390, 391, 392, 394, 397, 399, 406, 407, 408, 409, 410, 411, 415, 416, 417, 418, 420, 422, 621, 624, 626, 629, 631, 632, 634, 635, 637, 640, 643, 735, 736, 738, 740, 743]
